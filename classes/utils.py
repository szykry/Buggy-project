...
def get_args():
    ...
    parser.add_argument('--log-dir', type=str, default="../buggy/logs/a2c", help='log directory for Tensorboard')
    ...
    parser.add_argument('--std-advantage', action='store_true', default=True, help='Flag for using standardized advantage for better stability')
    ...
    parser.add_argument('--value-coeff', type=float, default=.5, metavar='VALUE_COEFF', help='value loss weight factor in the A2C loss')
    parser.add_argument('--entropy-coeff', type=float, default=.02, metavar='ENTROPY_COEFF', help='entropy loss weight factor in the A2C loss')
